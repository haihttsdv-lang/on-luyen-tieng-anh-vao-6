      ...
      {THEMATIC_GROUPS.map((group) => {
        ...
        return (
          <div key={group.id} className="mt-8">
            ...
            {/* UX-02: xếp 2 cột từ lg: — 36 bài xếp 1 cột trên màn hình rộng
                phải cuộn rất dài mới thấy hết nhóm cuối. */}
            <ol className="mt-2 grid grid-cols-1 gap-3 lg:grid-cols-2">
